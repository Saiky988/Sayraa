...
function processMapObj(accountAttributesMapObj) {
    ...
    accountAttributesMapObj['smart-shuffle'] = {
        stringValue: 'AVAILABLE'
    };
    accountAttributesMapObj['is-euterpe'] = {
        boolValue: true
    };
    accountAttributesMapObj['has-audiobooks-subscription'] = {
        boolValue: true
    };
    ...
    accountAttributesMapObj['subscription-enddate'] = {
        stringValue: endDateStr
    };
    accountAttributesMapObj['social-session-free-tier'] = {
        boolValue: false
    };
    accountAttributesMapObj['can_use_superbird'] = {
        boolValue: true
    };
    accountAttributesMapObj['jam-social-session'] = {
    ...
    accountAttributesMapObj['shuffle-algorithm'] = {
        stringValue: 'RANDOM'
    };
    accountAttributesMapObj['is-thalia'] = {
        boolValue: true
    };
    accountAttributesMapObj['shuffle'] = {
        boolValue: false
    };
    accountAttributesMapObj['is-pigeon'] = {
        boolValue: true
    };
    // 主页右下角的会员广告tab
    ...
    accountAttributesMapObj['your-library-tags'] = {
        boolValue: true
    };
    ...
    accountAttributesMapObj['product-expiry'] = {
        stringValue: endDateStr
    };
    accountAttributesMapObj['social-session'] = {
        boolValue: true
    };
    accountAttributesMapObj['pick-and-shuffle'] = {
        boolValue: false
    };
    accountAttributesMapObj['offline-backup'] = {
        stringValue: 'UNRESTRICTED'
    };
    accountAttributesMapObj['lyrics-offline'] = {
        boolValue: true
    };
    ...
    accountAttributesMapObj['mixing-tools'] = {
        stringValue: 'EDIT'
    };
